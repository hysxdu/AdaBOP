...
def get_args(argv):
    ...
    parser.add_argument('--model_lr', type=float,
                        default=0.0001, help="Classifier Learning rate")
    parser.add_argument('--head_lr', type=float,
                        default=0.001, help="Classifier Learning rate")
    parser.add_argument('--svd_lr', type=float, default=0.00005,
    ...
    parser.add_argument('--svd_thres', type=float,
                        default=10.0, help='reserve eigenvector')
